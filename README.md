...
Then start the install from disc (as per Step 5) process again and <span style="text-decoration:underline;">it will carry on where it left off</span>. DO NOT select the Overwrite Installation check box or you will have to re-download everything!
